...
CREATE TABLE `products` (
  ...
  `category` enum('Drink','Food','Household Goods','Electronics') NOT NULL,
...
('Coca-Cola', 'Drink', 1.50),
('Pepsi', 'Drink', 1.40),
('Bread', 'Food', 2.00),
('Eggs', 'Food', 3.50),
('Detergent', 'Household Goods', 4.99),
('Tissue', 'Household Goods', 2.50),
('Smartphone', 'Electronics', 250.00),
('Laptop', 'Electronics', 799.90);
COMMIT;
